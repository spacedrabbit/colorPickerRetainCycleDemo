//
//  CatSwiftHSVColorPicker.swift
//  ColorPickerRetainCycleDemo
//
//  Created by Louis Tur on 8/26/16.
...
public class CatSwiftHSVColorPicker: UIView, CatColorWheelDelegate, CatBrightnessViewDelegate {
    var colorWheel: CatColorWheel!
    var brightnessView: CatBrightnessView!
    ...
    func setup() {
        ...
        colorWheel = CatColorWheel(frame: CGRect(x: centeredX, y: CGRectGetMaxY(selectedColorView.frame), width: colorWheelSize, height: colorWheelSize), color: self.color)
        colorWheel.delegate = self
        // Add colorWheel as a subview of this view
        self.addSubview(colorWheel)
        
        // Init new BrightnessView subview
        brightnessView = CatBrightnessView(frame: CGRect(x: centeredX, y: CGRectGetMaxY(colorWheel.frame), width: colorWheelSize, height: brightnessViewHeight), color: self.color)
